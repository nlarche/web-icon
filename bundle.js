...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.WebIcon = exports.WebIconList = undefined;
	
	var _webIcon = __webpack_require__(2);
	
	var _webIcon2 = _interopRequireDefault(_webIcon);
	
	var _webIconList = __webpack_require__(164);
	
	var _webIconList2 = _interopRequireDefault(_webIconList);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.WebIconList = _webIconList2.default;
	exports.WebIcon = _webIcon2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webIcon = __webpack_require__(160);
	...
	var WebIcon = function (_React$Component) {
	    _inherits(WebIcon, _React$Component);
	
	    function WebIcon(props) {
	        _classCallCheck(this, WebIcon);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WebIcon).call(this, props));
	    ...
	    _createClass(WebIcon, [{
	        ...
	        key: 'searchFavicon',
	        value: function searchFavicon(url) {
	            var favicon;
	        ...
	        value: function render() {
	            ...
	            var imageStyle = this.props.grayscale ? _webIcon2.default.grayscale : _webIcon2.default.image;
	
	            var image = _react2.default.createElement('img', { src: this.state.favicon, alt: this.state.name, className: imageStyle, onLoad: this.onLoad });
	
	            return _react2.default.createElement(
	                'div',
	                { className: _webIcon2.default.webIcon },
	                _react2.default.createElement(
	                    'div',
	                    { className: loaded ? null : _webIcon2.default.hidden },
	                    !noLink && _react2.default.createElement(
	                        'a',
	                        { href: this.state.origin, title: this.state.name, target: '_blank' },
	                        image
	                    ),
	                    noLink && image
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: loaded ? _webIcon2.default.hidden : null },
	                    _react2.default.createElement('div', { className: _webIcon2.default.preview })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./web-icon.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./web-icon.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".web-icon__webIconList___Pja4A  {\n    display: flex;\n    flex-direction: row;    \n    width : 20vw;    \n}\n.web-icon__webIcon___3gGku {\n    display: flex;\n    align-items: center;    \n    height: 33%;\n    margin: 10px\n}\n.web-icon__image___2kOJA  {\n    width: 20px;\n}     \n.web-icon__hidden___2Sju2 { \n    display:none; \n}\n.web-icon__preview___5HJ40 {\n    background-color:#E2E2E2;\n    width:20px;\n    height:20px; \n    border-radius: 5px;\n}\n.web-icon__grayscale___2bM1b {\n    filter: gray;\n    filter: grayscale(1);\n    -webkit-filter: grayscale(1);\n}\n", ""]);
	
	// exports
	exports.locals = {
		"webIconList": "web-icon__webIconList___Pja4A",
		"webIcon": "web-icon__webIcon___3gGku",
		"image": "web-icon__image___2kOJA",
		"hidden": "web-icon__hidden___2Sju2",
		"preview": "web-icon__preview___5HJ40",
		"grayscale": "web-icon__grayscale___2bM1b web-icon__image___2kOJA"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _webIcon3 = __webpack_require__(160);
	
	var _webIcon4 = _interopRequireDefault(_webIcon3);
	...
	var WebIconList = function (_React$Component) {
	    _inherits(WebIconList, _React$Component);
	
	    function WebIconList(props) {
	        _classCallCheck(this, WebIconList);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WebIconList).call(this, props));
	    ...
	    _createClass(WebIconList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: _webIcon4.default.webIconList },
	                this.state.websites.map(function (app) {
	                    return _react2.default.createElement(_webIcon2.default, { url: app, key: _this2.state.websites.indexOf(app), noLink: _this2.props.noLink, grayscale: _this2.props.grayscale });
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebIconList = __webpack_require__(1).WebIconList;
	...
	ReactDOM.render(React.createElement(WebIconList, { websites: liste }), document.getElementById('content'));
	
	ReactDOM.render(React.createElement(WebIconList, { websites: liste, noLink: true, grayscale: true }), document.getElementById('content-noLink'));
